...
def get(time_map_body : TimeMapKeyTimestampSchema, time_map_service : TimeMapService = Depends()):
...
def put(time_map_body : TimeMapSchema, time_map_service : TimeMapService = Depends()):
